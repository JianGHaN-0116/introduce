  ...
  return (
    <SectionWrapper id="experience">
      ...
      <div className="relative">
        <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-white/10 via-white/5 to-transparent" />
        ...
        {siteConfig.experience.map((exp, i) => (
          ...
          >
            <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-cyan-400/50 border border-cyan-400/20 mt-2" />
            ...
            >
              <span className="text-xs text-white/25">{exp.year}</span>
            </div>
            ...
            >
              <div className="glass-card rounded-xl p-5 transition-all duration-300 hover:-translate-y-0.5">
                ...
                <p className="text-xs text-white/30 mb-2">{exp.organization}</p>
